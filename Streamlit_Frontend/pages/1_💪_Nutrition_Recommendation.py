...
st.set_page_config(page_title="Automatic Nutrition Recommendation", page_icon="💪",layout="wide")
...
display=Display()
title="<h1 style='text-align: center;'>Automatic Nutrition Recommendation</h1>"
